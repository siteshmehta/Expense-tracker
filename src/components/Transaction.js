    ...
    <div className="row shadow-sm m-0 mt-2">
      <div className="col-12 m-0 p-0">
        <div className="row m-0 p-0">
          <div className="col-sm-5 col-md-9 " style={{"color":font_color,"borderLeft":border_color}}>{transaction["text"]}</div>
          <div className=" col-sm-2  col-md-2 text-right">{symbol} &#8377;{ Math.abs(transaction["amount"])}</div>
